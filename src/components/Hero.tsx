    ...
    <section className="relative min-h-screen pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden bg-gradient-to-b from-black via-purple-900 to-blue-900">
      ...
      <div ref={containerRef} className="container px-4 mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div 
            data-animate
            className="inline-block mb-6 py-1.5 px-4 bg-purple-500/20 text-purple-300 rounded-full text-sm font-medium opacity-0"
          >
          ...
          >
            ...
            <span className="text-gradient bg-gradient-to-r from-purple-400 to-blue-500">Hacksyke 2.0</span>
          </h1>
          
          {/* Subtitle */}
          <p 
            data-animate
            className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8 opacity-0 animation-delay-400"
          >
          ...
          >
            <div className="flex items-center gap-2 bg-black/30 backdrop-blur-sm py-2 px-4 rounded-full shadow-subtle border border-purple-500/20">
          ...
          >
            <div className="bg-black/30 backdrop-blur-sm inline-block px-6 py-3 rounded-lg border border-purple-500/20">
              <p className="text-gray-300 mb-1">Join from just</p>
              <p className="text-2xl font-bold text-purple-300">₹900 <span className="text-sm font-normal text-gray-400">(offline)</span> or <span className="text-purple-300 font-bold">FREE</span> <span className="text-sm font-normal text-gray-400">(online)</span></p>
              <p className="text-xs text-gray-400 mt-1">*Sponsors might drop it to ₹0—stay tuned!</p>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:block absolute top-1/2 -translate-y-1/2 left-5 animate-float">
          <div className="w-12 h-12 border border-purple-500/20 rounded-lg rotate-[15deg]"></div>
        </div>
        ...
        <div className="hidden md:block absolute bottom-10 left-1/4 animate-float animation-delay-600">
          <div className="w-10 h-10 border border-purple-500/20 rounded-md rotate-[35deg]"></div>
        </div>
      </div>
    </section>
  );
