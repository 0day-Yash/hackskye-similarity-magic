  ...
  return (
    <section id="hub" className="py-20 bg-gradient-to-b from-blue-900 via-purple-900 to-black relative overflow-hidden">
      ...
      <div ref={containerRef} className="container px-4 mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {hubFeatures.map((feature, index) => (
            <div 
              key={index}
              data-animate
              className={`bg-black/30 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 shadow-xl hover:shadow-purple-500/5 transition-all duration-300 opacity-0 animation-delay-${(index + 1) * 200}`}
            >
        ...
        <div 
          data-animate
          className="text-center bg-gradient-to-r from-purple-900/30 to-blue-900/30 rounded-xl p-8 border border-purple-500/20 shadow-xl opacity-0 animation-delay-800 max-w-3xl mx-auto"
        >
